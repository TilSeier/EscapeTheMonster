package com.tilseier.escapethemonster.repository
...
class LevelsRepository(private val levelDao: LevelDao) {

    companion object {
        var instance: LevelsRepository? = null

        fun newInstance(levelDao: LevelDao): LevelsRepository? {
            if (instance == null) {
                instance =
                    LevelsRepository(levelDao)
            }
            return instance
        }
    }
    ...
    private val levels: LiveData<List<Level>> = levelDao.getLevels()
